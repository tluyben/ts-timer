...
function fibonacci(n: any): any { _____sftimer = new Date(); _____sftimer_1 = new Date(); let n1 = 0, n2 = 1, nextTerm; _____eftimer_1 = new Date(); _____ptimers.push({
    line: 1,
    code: "let n1 = 0,\n    n2 = 1,\n    nextTerm;",
    start: _____sftimer_1,
    end: _____eftimer_1,
    diff: (_____eftimer_1 - _____sftimer_1).valueOf()
}); _____sftimer_1 = new Date(); console.log("Fibonacci Series:"); _____eftimer_1 = new Date(); _____ptimers.push({
    line: 4,
    code: "console.log(\"Fibonacci Series:\");",
    start: _____sftimer_1,
    end: _____eftimer_1,
    diff: (_____eftimer_1 - _____sftimer_1).valueOf()
}); _____sftimer_1 = new Date(); for (let i = 1; i <= n; i++) {
...
} _____eftimer_1 = new Date(); _____ptimers.push({
    line: 5,
    code: "for (let i = 1; i <= n; i++) {\n    console.log(n1);\n    nextTerm = n1 + n2;\n    n1 = n2;\n    n2 = nextTerm;\n  }",
    start: _____sftimer_1,
    end: _____eftimer_1,
    diff: (_____eftimer_1 - _____sftimer_1).valueOf()
}); _____eftimer = new Date(); _____ptimers.push({
    line: 1,
